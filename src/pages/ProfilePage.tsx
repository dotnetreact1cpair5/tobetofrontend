...
const Profile: React.FC = () => {
  ...
  return (
    <main
      id="profile-page"
      className="grid grid-cols-1 md:grid-cols-3 gap-4 p-4 profile-page-container"
    >
            <div className="top">
              <span> 
                <img
                src="/public/edit2.svg"
                alt="edit"
                className="ali"
                />
              </span>
      ...
      <div className="grid grid-rows-3 gap-4 md:col-span-1">
        ...
        <ProfileCard title="Hakkımda" isShareImgVisible={false}>Info</ProfileCard>

        <ProfileCard title="Yetkinliklerim" isShareImgVisible={false}>Info</ProfileCard>

        <ProfileCard title="Yabancı Dillerim" isShareImgVisible={false}>Info</ProfileCard>

        <ProfileCard title="Sertifikalarım" isShareImgVisible={false}>Info</ProfileCard>
      ...
      <div className="grid grid-rows-2 gap-4 md:col-span-2">
        ...
        {experienceData.map((data) => (
          <ProfileCard title="Eğitim Hayatım ve Deneyimlerim" key={data.id} isShareImgVisible={false}>
            <div className="cv-info">
              <div className="info-box">
                <span className="text">
                  {data.companyName}
